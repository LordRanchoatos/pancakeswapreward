...
import { ReactComponent as WhiteArrowIcon } from "../assets/white-arrow-icon.svg";

const Footer = () => {
  return (
    <div className={styles.Footer}>
      <div className={styles.FooterMain}>
        <div className={styles.FooterDesktopHide}>
          <svg
            viewBox="0 0 160 26"
            width="130px"
            color="text"
        ...
        <div className={styles.FooterDesktopOrderOne}>
          <ul className={styles.FooterListing}>
            <li className={styles.FooterListingItem}>About</li>
            <li className={styles.FooterListingItem}>
              <a
                href="https://docs.pancakeswap.finance/contact-us"
                target="_blank"
                rel="noreferrer noopener"
                color="#F4EEFF"
                className={styles.FooterListingItemLink}
              >
                Contact
              </a>
            </li>
            ...
            <li className={styles.FooterListingItem}>
              <span className={styles.ShortHypen}>—</span>
            </li>
            <li className={styles.FooterListingItem}>
              <a
          ...
          <ul className={styles.FooterListing}>
            <li className={styles.FooterListingItem}>Help</li>
            <li className={styles.FooterListingItem}>
              <a
          ...
          <ul className={styles.FooterListing}>
            <li className={styles.FooterListingItem}>Developers</li>
            <li className={styles.FooterListingItem}>
              <a
        ...
        <div className={styles.FooterDesktopOrderTwo}>
          <a
            target="_blank"
            rel="noreferrer noopener"
          ...
          <div>
            <Telegram className={styles.TelegramStyling} />
          </div>
          <a
            target="_blank"
            rel="noreferrer noopener"
        ...
        <div className={styles.FooterDesktopOrderThree}>
          <div className={styles.FooterClickArea}>
            <div style={{ marginRight: "20px" }}>
              <a
                ...
                rel="noreferrer"
              >
                <CakeLogo className={styles.FooterClickAreaSvg} />
                <div
                  style={{
            ...
            <a
              className={styles.FooterBuyCakeButton}
              href="https://pancakeswap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82"
              target="_blank"
              rel="noreferrer"
            >
              Buy CAKE
              <WhiteArrowIcon className={styles.WhiteArrowIcon} />
            </a>
          </div>
        </div>
      </div>
